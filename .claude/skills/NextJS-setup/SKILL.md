# Next.js 15 Project Setup Skill

## Purpose
Initialize a production-ready Next.js 15+ project with App Router, TypeScript, Tailwind CSS, and shadcn/ui.

## When to Use
- Starting a new Next.js frontend project
- Setting up modern React application
- Configuring TypeScript and Tailwind
- Adding component library (shadcn/ui)
...
## Next Steps
After setup:
1. Use **API Client Generator** skill to create backend integration
2. Use **Better Auth Integration** skill for authentication
